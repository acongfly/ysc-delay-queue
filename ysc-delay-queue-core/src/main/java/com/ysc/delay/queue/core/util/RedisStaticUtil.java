...
public class RedisStaticUtil {
    ...
    private static RedisStaticUtil RedisUtil;
    ...
    public RedisStaticUtil(StringRedisTemplate stringRedisTemplate) {
    ...
    public static byte[] dump(String key) {
        return RedisUtil.stringRedisTemplate.dump(key);
    }
    ...
    public static Boolean expire(String key, long timeout, TimeUnit unit) {
        return RedisUtil.stringRedisTemplate.expire(key, timeout, unit);
    }
    ...
    public static Boolean expireAt(String key, Date date) {
        return RedisUtil.stringRedisTemplate.expireAt(key, date);
    }
    ...
    public static Boolean move(String key, int dbIndex) {
        return RedisUtil.stringRedisTemplate.move(key, dbIndex);
    }
    ...
    public static Boolean persist(String key) {
        return RedisUtil.stringRedisTemplate.persist(key);
    }
    ...
    public static Long getExpire(String key, TimeUnit unit) {
        return RedisUtil.stringRedisTemplate.getExpire(key, unit);
    }
    ...
    public static String randomKey() {
        return RedisUtil.stringRedisTemplate.randomKey();
    }
    ...
    public static void rename(String oldKey, String newKey) {
        RedisUtil.stringRedisTemplate.rename(oldKey, newKey);
    }
    ...
    public static Boolean renameIfAbsent(String oldKey, String newKey) {
        return RedisUtil.stringRedisTemplate.renameIfAbsent(oldKey, newKey);
    }
    ...
    public static DataType type(String key) {
        return RedisUtil.stringRedisTemplate.type(key);
    }
    ...
    public static String getRange(String key, long start, long end) {
        return RedisUtil.stringRedisTemplate.opsForValue().get(key, start, end);
    }
    ...
    public static String getAndSet(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForValue().getAndSet(key, value);
    }
    ...
    public static Boolean getBit(String key, long offset) {
        return RedisUtil.stringRedisTemplate.opsForValue().getBit(key, offset);
    }
    ...
    public static List<String> multiGet(Collection<String> keys) {
        return RedisUtil.stringRedisTemplate.opsForValue().multiGet(keys);
    }
    ...
    public static boolean setBit(String key, long offset, boolean value) {
        return RedisUtil.stringRedisTemplate.opsForValue().setBit(key, offset, value);
    }
    ...
    public static boolean setIfAbsent(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForValue().setIfAbsent(key, value);
    }
    ...
    public static Long size(String key) {
        return RedisUtil.stringRedisTemplate.opsForValue().size(key);
    }
    ...
    public static void multiSet(Map<String, String> maps) {
        RedisUtil.stringRedisTemplate.opsForValue().multiSet(maps);
    }
    ...
    public static boolean multiSetIfAbsent(Map<String, String> maps) {
        return RedisUtil.stringRedisTemplate.opsForValue().multiSetIfAbsent(maps);
    }
    ...
    public static Long incrBy(String key, long increment) {
        return RedisUtil.stringRedisTemplate.opsForValue().increment(key, increment);
    }
    ...
    public static Integer append(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForValue().append(key, value);
    }
    ...
    public static Object hGet(String key, String field) {
        return RedisUtil.stringRedisTemplate.opsForHash().get(key, field);
    }
    ...
    public static Map<Object, Object> hGetAll(String key) {
        return RedisUtil.stringRedisTemplate.opsForHash().entries(key);
    }
    ...
    public static List<Object> hMultiGet(String key, Collection<Object> fields) {
        return RedisUtil.stringRedisTemplate.opsForHash().multiGet(key, fields);
    }

    public static void hPut(String key, String hashKey, String value) {
        RedisUtil.stringRedisTemplate.opsForHash().put(key, hashKey, value);
    }

    public static void hPutAll(String key, Map<String, String> maps) {
        RedisUtil.stringRedisTemplate.opsForHash().putAll(key, maps);
    }
    ...
    public static Boolean hPutIfAbsent(String key, String hashKey, String value) {
        return RedisUtil.stringRedisTemplate.opsForHash().putIfAbsent(key, hashKey, value);
    }
    ...
    public static Long hDelete(String key, Object... fields) {
        return RedisUtil.stringRedisTemplate.opsForHash().delete(key, fields);
    }
    ...
    public static boolean hExists(String key, String field) {
        return RedisUtil.stringRedisTemplate.opsForHash().hasKey(key, field);
    }
    ...
    public static Long hIncrBy(String key, Object field, long increment) {
        return RedisUtil.stringRedisTemplate.opsForHash().increment(key, field, increment);
    }
    ...
    public static Double hIncrByFloat(String key, Object field, double delta) {
        return RedisUtil.stringRedisTemplate.opsForHash().increment(key, field, delta);
    }
    ...
    public static Set<Object> hKeys(String key) {
        return RedisUtil.stringRedisTemplate.opsForHash().keys(key);
    }
    ...
    public static Long hSize(String key) {
        return RedisUtil.stringRedisTemplate.opsForHash().size(key);
    }
    ...
    public static List<Object> hValues(String key) {
        return RedisUtil.stringRedisTemplate.opsForHash().values(key);
    }
    ...
    public static Cursor<Entry<Object, Object>> hScan(String key, ScanOptions options) {
        return RedisUtil.stringRedisTemplate.opsForHash().scan(key, options);
    }
    ...
    public static String lIndex(String key, long index) {
        return RedisUtil.stringRedisTemplate.opsForList().index(key, index);
    }
    ...
    public static Long lLeftPush(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().leftPush(key, value);
    }
    ...
    public static Long lLeftPushAll(String key, String... value) {
        return RedisUtil.stringRedisTemplate.opsForList().leftPushAll(key, value);
    }
    ...
    public static Long lLeftPushIfPresent(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().leftPushIfPresent(key, value);
    }
    ...
    public static Long lLeftPush(String key, String pivot, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().leftPush(key, pivot, value);
    }
    ...
    public static Long lRightPush(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().rightPush(key, value);
    }
    ...
    public static Long lRightPushAll(String key, String... value) {
        return RedisUtil.stringRedisTemplate.opsForList().rightPushAll(key, value);
    }
    ...
    public static Long lRightPushIfPresent(String key, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().rightPushIfPresent(key, value);
    }
    ...
    public static Long lRightPush(String key, String pivot, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().rightPush(key, pivot, value);
    }
    ...
    public static void lSet(String key, long index, String value) {
        RedisUtil.stringRedisTemplate.opsForList().set(key, index, value);
    }
    ...
    public static String lLeftPop(String key) {
        return RedisUtil.stringRedisTemplate.opsForList().leftPop(key);
    }
    ...
    public static String lBLeftPop(String key, long timeout, TimeUnit unit) {
        return RedisUtil.stringRedisTemplate.opsForList().leftPop(key, timeout, unit);
    }
    ...
    public static String lRightPop(String key) {
        return RedisUtil.stringRedisTemplate.opsForList().rightPop(key);
    }
    ...
    public static String lBRightPop(String key, long timeout, TimeUnit unit) {
        return RedisUtil.stringRedisTemplate.opsForList().rightPop(key, timeout, unit);
    }
    ...
    public static Long lRemove(String key, long index, String value) {
        return RedisUtil.stringRedisTemplate.opsForList().remove(key, index, value);
    }
    ...
    public static void lTrim(String key, long start, long end) {
        RedisUtil.stringRedisTemplate.opsForList().trim(key, start, end);
    }
    ...
    public static Long sAdd(String key, String... values) {
        return RedisUtil.stringRedisTemplate.opsForSet().add(key, values);
    }
    ...
    public static Long sRemove(String key, Object... values) {
        return RedisUtil.stringRedisTemplate.opsForSet().remove(key, values);
    }
    ...
    public static String sPop(String key) {
        return RedisUtil.stringRedisTemplate.opsForSet().pop(key);
    }
    ...
    public static Boolean sMove(String key, String value, String destKey) {
        return RedisUtil.stringRedisTemplate.opsForSet().move(key, value, destKey);
    }
    ...
    public static Boolean sIsMember(String key, Object value) {
        return RedisUtil.stringRedisTemplate.opsForSet().isMember(key, value);
    }
    ...
    public static Set<String> sIntersect(String key, String otherKey) {
        return RedisUtil.stringRedisTemplate.opsForSet().intersect(key, otherKey);
    }
    ...
    public static Set<String> sIntersect(String key, Collection<String> otherKeys) {
        return RedisUtil.stringRedisTemplate.opsForSet().intersect(key, otherKeys);
    }
    ...
    public static Set<String> sUnion(String key, String otherKeys) {
        return RedisUtil.stringRedisTemplate.opsForSet().union(key, otherKeys);
    }
    ...
    public static Long sUnionAndStore(String key, String otherKey, String destKey) {
        return RedisUtil.stringRedisTemplate.opsForSet().unionAndStore(key, otherKey, destKey);
    }
    ...
    public static Set<String> sDifference(String key, String otherKey) {
        return RedisUtil.stringRedisTemplate.opsForSet().difference(key, otherKey);
    }
    ...
    public static Set<String> sDifference(String key, Collection<String> otherKeys) {
        return RedisUtil.stringRedisTemplate.opsForSet().difference(key, otherKeys);
    }
    ...
    public static Set<String> setMembers(String key) {
        return RedisUtil.stringRedisTemplate.opsForSet().members(key);
    }
    ...
    public static String sRandomMember(String key) {
        return RedisUtil.stringRedisTemplate.opsForSet().randomMember(key);
    }
    ...
    public static List<String> sRandomMembers(String key, long count) {
        return RedisUtil.stringRedisTemplate.opsForSet().randomMembers(key, count);
    }
    ...
    public static Set<String> sDistinctRandomMembers(String key, long count) {
        return RedisUtil.stringRedisTemplate.opsForSet().distinctRandomMembers(key, count);
    }
    ...
    public static Boolean zAdd(String key, String value, double score) {
        return RedisUtil.stringRedisTemplate.opsForZSet().add(key, value, score);
    }
    ...
    public static Long zAdd(String key, Set<TypedTuple<String>> values) {
        return RedisUtil.stringRedisTemplate.opsForZSet().add(key, values);
    }
    ...
    public static Long zRemove(String key, Object... values) {
        return RedisUtil.stringRedisTemplate.opsForZSet().remove(key, values);
    }
    ...
    public static Double zIncrementScore(String key, String value, double delta) {
        return RedisUtil.stringRedisTemplate.opsForZSet().incrementScore(key, value, delta);
    }
    ...
    public static Long zRank(String key, Object value) {
        return RedisUtil.stringRedisTemplate.opsForZSet().rank(key, value);
    }
    ...
    public static Long zReverseRank(String key, Object value) {
        return RedisUtil.stringRedisTemplate.opsForZSet().reverseRank(key, value);
    }
    ...
    public static Set<String> zRange(String key, long start, long end) {
        return RedisUtil.stringRedisTemplate.opsForZSet().range(key, start, end);
    }
    ...
    public static Set<String> zRangeByScore(String key, double min, double max) {
        return RedisUtil.stringRedisTemplate.opsForZSet().rangeByScore(key, min, max);
    }
    ...
    public static Set<String> zReverseRange(String key, long start, long end) {
        return RedisUtil.stringRedisTemplate.opsForZSet().reverseRange(key, start, end);
    }
    ...
    public static Long zCount(String key, double min, double max) {
        return RedisUtil.stringRedisTemplate.opsForZSet().count(key, min, max);
    }
    ...
    public static Long zSize(String key) {
        return RedisUtil.stringRedisTemplate.opsForZSet().size(key);
    }
    ...
    public static Long zZCard(String key) {
        return RedisUtil.stringRedisTemplate.opsForZSet().zCard(key);
    }
    ...
    public static Double zScore(String key, Object value) {
        return RedisUtil.stringRedisTemplate.opsForZSet().score(key, value);
    }
    ...
    public static Long zRemoveRange(String key, long start, long end) {
        return RedisUtil.stringRedisTemplate.opsForZSet().removeRange(key, start, end);
    }
    ...
    public static Long zRemoveRangeByScore(String key, double min, double max) {
        return RedisUtil.stringRedisTemplate.opsForZSet().removeRangeByScore(key, min, max);
    }
    ...
    public static Long zUnionAndStore(String key, String otherKey, String destKey) {
        return RedisUtil.stringRedisTemplate.opsForZSet().unionAndStore(key, otherKey, destKey);
    }
    ...
    public static Cursor<TypedTuple<String>> zScan(String key, ScanOptions options) {
        return RedisUtil.stringRedisTemplate.opsForZSet().scan(key, options);
    }
    ...
    public static <T> List<T> getListCache(final String key, Class<T> targetClass) {
        byte[] result = RedisUtil.stringRedisTemplate.execute(new RedisCallback<byte[]>() {
            @Override
    ...
    public static <T> boolean putListCacheWithExpireTime(String key, List<T> objList, final long expireTime) {
        ...
        boolean result = RedisUtil.stringRedisTemplate.execute(new RedisCallback<Boolean>() {
            @Override
    ...
    public static boolean unLock(String key, String value) {
        ...
        Long execute = RedisUtil.stringRedisTemplate.execute(redisScript, Collections.singletonList(key), value);
